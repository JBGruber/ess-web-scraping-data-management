...
# Correction: xpaths {.incremental}

- When I told you it's not worth learning xpath, I was thinking about static xpaths like this:

```{xml}
/html/body/div[3]/div/div[3]/main/div[3]/div[3]/div[2]/section[4]/section/table/tbody/tr[1]/td[3]/div[1]/a
```

- However, I forgot that dynmic xpath also exists, which looks like this:

```{xml}
"descendant-or-self::table/descendant::a"
```

- Which is actually what `rvest` always uses under the hood by translating CSS to xpath with the `selectr` package:

```{r}
selectr::css_to_xpath("table a")
```

- This dynamic xpath can be very useful and contains more functionality than CSS selectors, but it's harder to learn and only useful in special cases
...
1. Get the table with 2025 opinion polling for the next United Kingdom general election from <https://en.wikipedia.org/w/index.php?title=Opinion_polling_for_the_next_United_Kingdom_general_election&oldid=1366502041>
...
# 1. Request & collect raw html
html <- read_html(
  "https://en.wikipedia.org/w/index.php?title=List_of_prime_ministers_of_the_United_Kingdom&oldid=1366130861"
) # I pinned this to the version 13:01, 26 July 2026 so that it still works, even if the site is updated

# 2. Parse
pm_table <- html |>
  html_elements(".wikitable") |>
  keep(function(x) str_detect(html_text(x), "List of prime ministers")) |>
  map(function(x) as_tibble(html_table(x), .name_repair = "unique")) |>
  bind_rows() |>
...
links <- html |>
  html_elements(".wikitable") |>
  keep(function(x) str_detect(html_text(x), "List of prime ministers")) |>
  html_elements("td [style=\"font-size:100%;\"] a[title]") |>
  html_attr("href")
title <- html |>
  html_elements(".wikitable") |>
  keep(function(x) str_detect(html_text(x), "List of prime ministers")) |>
...
2. Wikipedia recently started using absolute links. Before that, they used relative links, such as many other websites still do. Relative links look like this:

```{r}
links <- c(
  "/wiki/Robert_Walpole",
  "/wiki/Spencer_Compton,_1st_Earl_of_Wilmington",
  "/wiki/Henry_Pelham",
  "/wiki/Thomas_Pelham-Holles",
  "/wiki/William_Cavendish,_4th_Duke_of_Devonshire",
  "/wiki/Thomas_Pelham-Holles",
  "/wiki/John_Stuart,_3rd_Earl_of_Bute",
  "/wiki/George_Grenville",
  "/wiki/Charles_Watson-Wentworth",
  "/wiki/William_Pitt_the_Elder",
  "/wiki/Augustus_FitzRoy,_3rd_Duke_of_Grafton",
  "/wiki/Frederick_North,_Lord_North",
  "/wiki/Charles_Watson-Wentworth",
  "/wiki/William_Petty,_2nd_Earl_of_Shelburne",
  "/wiki/William_Cavendish-Bentinck,_3rd_Duke_of_Portland",
  "/wiki/William_Pitt_the_Younger",
  "/wiki/Henry_Addington",
  "/wiki/William_Pitt_the_Younger",
  "/wiki/William_Grenville",
  "/wiki/William_Cavendish-Bentinck,_3rd_Duke_of_Portland",
  "/wiki/Spencer_Perceval",
  "/wiki/Robert_Jenkinson,_2nd_Earl_of_Liverpool",
  "/wiki/George_Canning",
  "/wiki/Frederick_John_Robinson",
  "/wiki/Arthur_Wellesley,_1st_Duke_of_Wellington",
  "/wiki/Charles_Grey,_2nd_Earl_Grey",
  "/wiki/William_Lamb,_2nd_Viscount_Melbourne",
  "/wiki/Arthur_Wellesley,_1st_Duke_of_Wellington",
  "/wiki/Robert_Peel",
  "/wiki/William_Lamb,_2nd_Viscount_Melbourne",
  "/wiki/Robert_Peel",
  "/wiki/Lord_John_Russell",
  "/wiki/Edward_Smith-Stanley,_14th_Earl_of_Derby",
  "/wiki/George_Hamilton-Gordon,_4th_Earl_of_Aberdeen",
  "/wiki/Henry_John_Temple",
  "/wiki/Edward_Smith-Stanley,_14th_Earl_of_Derby",
  "/wiki/Henry_John_Temple",
  "/wiki/John_Russell,_1st_Earl_Russell",
  "/wiki/Edward_Smith-Stanley,_14th_Earl_of_Derby",
  "/wiki/Benjamin_Disraeli",
  "/wiki/William_Ewart_Gladstone",
  "/wiki/Benjamin_Disraeli",
  "/wiki/William_Ewart_Gladstone",
  "/wiki/Robert_Gascoyne-Cecil,_3rd_Marquess_of_Salisbury",
  "/wiki/William_Ewart_Gladstone",
  "/wiki/Robert_Gascoyne-Cecil,_3rd_Marquess_of_Salisbury",
  "/wiki/William_Ewart_Gladstone",
  "/wiki/Archibald_Primrose,_5th_Earl_of_Rosebery",
  "/wiki/Robert_Gascoyne-Cecil,_3rd_Marquess_of_Salisbury",
  "/wiki/Arthur_Balfour",
  "/wiki/Henry_Campbell-Bannerman",
  "/wiki/H._H._Asquith",
  "/wiki/David_Lloyd_George",
  "/wiki/Bonar_Law",
  "/wiki/Stanley_Baldwin",
  "/wiki/Ramsay_MacDonald",
  "/wiki/Stanley_Baldwin",
  "/wiki/Ramsay_MacDonald",
  "/wiki/Stanley_Baldwin",
  ...
  "/wiki/Winston_Churchill",
  "/wiki/Anthony_Eden",
  "/wiki/Harold_Macmillan",
  "/wiki/Alec_Douglas-Home",
  "/wiki/Harold_Wilson",
  "/wiki/Edward_Heath",
  "/wiki/Harold_Wilson",
  "/wiki/James_Callaghan",
...
How could you convert the `links` object above so that it contains actual URLs?
...
:::: {.columns}
::: {.column width="50%"}
1. Collect all reviews from a given Thomann page
2. Identify and extract relevant variables for each review
:::
::: {.column width="50%" }
[![](media/thomann.png)](https://www.thomann.co.uk/beyerdynamic_dt770_pro80_ohm.htm){target="_blank"}
:::
::::
...
- We can spot two things:
  - there are 2906 reviews for this product (478 in English)
  - there are 45 pages with reviews
- (here you can get all reviews. E.g., Thomann limits results to 10 pages per query)
...
# the rating system on this page is very interesting, instead of showing you
# a number of stars, it overlays greyed out stars with a colour and sets a
# width. 60% width of filled stars means 3/5 stars
...
get_reviews_from_page <- function(link) {
  html <- try(read_html(link))

  while (is(html, "try-error")) {
    Sys.sleep(3)
    html <- try(read_html(link))
  }
...
# 1. Request & collect raw html
html <- read_html(
  "https://web.archive.org/web/20250819084103/https://news.sky.com/story/crowdstrike-company-that-caused-global-techno-meltdown-offers-partners-10-vouchers-to-say-sorry-and-they-dont-work-13184488"
)
...
Why I use the *Internet Archive*'s version:

```{r}
#| error: true
#| classes: "fragment"
html <- read_html(
  "https://news.sky.com/story/crowdstrike-company-that-caused-global-techno-meltdown-offers-partners-10-vouchers-to-say-sorry-and-they-dont-work-13184488"
)
```
:::
...
```{r}
html <- read_html(
  "https://www.zeit.de/mobilitaet/2024-04/deutschlandticket-klimaschutz-oeffentliche-verkehrsmittel-autos-verkehrswende"
)
html |>
...
html <- request(
  "https://web.archive.org/web/20240519142346/https://www.parliament.gov.za/register-members-Interests"
) |>
  req_timeout(100) |>
  req_perform() |>
  resp_body_html()
...
p1 |>
  mutate(
    is_name = font_name == "Arial-BoldMT" &
      round(font_size, 3) == 8.775
  ) |>
  # add whether header
  mutate(
    is_header = font_name == "Arial-BoldMT" &
