...
- You will receive instroctions for 2 exam papers and a Honesty declaration immediatly after class today
- 
...
# 5. Database Software and Scaling your Analyses
## 5. Database Software and Scaling your Analyses: What we learned about
...
1. Can you get content with `rvest::read_html`?
2. Does the content contain known values that are interesting?
3. Can you get content with `rvest::read_html_live`?
4. Does the content contain known values that are interesting?
5. Have you checked `$view` on the object you got from `rvest::read_html_live`?
6. Can you manipulate the page you see in `$view`?
7. Does this give you all content or do you need `click` or `scroll_*`?
8. Can you get the content with `scrapling`?
9. Last resort: is the page supported by <https://github.com/digitalmethodsinitiative/zeeschuimer>?
...
## paperboy goes AI: my current approach

<video class="r-stretch" controls preload="metadata" src="media/paperboy.mp4" title="paperboy: new-parser Claude"></video>

W[Link to command](https://github.com/JBGruber/paperboy/blob/8e1850ef7910eefe7cbfd0d4d9a2167567245d2d/.claude/commands/new-parser.md)
