...
```{r}
curl_translate(
  "curl 'https://whova.com/xems/apis/event_webpage/agenda/public/get_agendas/?event_id=JcQAdK91J0qLUtNxOYUVWFMTUuQgIg3Xj6VIeeyXVR4%3D' \
...
```{r}
ica_data[["data"]][["agenda"]][[4]][["time_ranges"]][[3]][[2]][[65]][[1]][[
  "sessions"
]][[1]] |>
...
twitter_resp <- request(
  "https://api.x.com/graphql/Le1DChzkS7ioJH_yEPMi3w/UserTweets"
) |>
  req_url_query(
